                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6">
                    @foreach ($users as $user)
                        <a href="{{ route('profile.show', $user->id) }}"
                            class="flex flex-col items-center bg-gray-50 dark:bg-gray-800 rounded-xl p-4 shadow hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 hover:bg-blue-50 dark:hover:bg-gray-700">
                            <div class="relative">
                                @if ($user->photo)
