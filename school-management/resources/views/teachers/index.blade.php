                ...
                <div class="p-6 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <div class="p-6">
                                <div class="flex items-center">
                                    <img class="w-16 h-16 rounded-full object-cover"
                                        ...
                                        alt="Dr. James Wilson">
                                    <div class="ml-4">
                                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Dr. James Wilson
                                        </h3>
                                        ...
                                        <div class="flex items-center mt-1">
                                            ...
                                            <span class="text-gray-600 dark:text-gray-300 text-sm ml-1">4.8 (120
                                                reviews)</span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div
                            ...
                            <div class="p-6">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Dr. Sarah
                                            Johnson</h3>
                                        ...
                                        <div class="flex items-center mt-1">
                                            ...
                                            <span class="text-gray-600 dark:text-gray-300 text-sm ml-1">4.9 (98
                                                reviews)</span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div
                            ...
                            <div class="p-6">
                                <div class="flex items-center">
                                    <img class="w-16 h-16 rounded-full object-cover"
                                        src="https://images.unsplash.com/photo-1560250097-0b93528c311a?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=4&w=256&h=256&q=60"
                                        alt="Mr. Robert Chen">
                                    <div class="ml-4">
                                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Mr. Robert Chen
                                        </h3>
                                        ...
                                        <div class="flex items-center mt-1">
                                            ...
                                            <span class="text-gray-600 dark:text-gray-300 text-sm ml-1">4.7 (85
                                                reviews)</span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div
                            ...
                            <div class="p-6">
                                <div class="flex items-center">
                                    <img class="w-16 h-16 rounded-full object-cover"
                                        src="https://images.unsplash.com/photo-1544005313-94ddf0286df2?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=4&w=256&h=256&q=60"
                                        alt="Ms. Emily Davis">
                                    <div class="ml-4">
                                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Ms. Emily Davis
                                        </h3>
                                        ...
                                        <div class="flex items-center mt-1">
                                            ...
                                            <span class="text-gray-600 dark:text-gray-300 text-sm ml-1">4.6 (112
                                                reviews)</span>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="mt-8 flex items-center justify-between">
                        ...
                        <div class="flex space-x-2">
                            ...
                            <button
                                class="px-3 py-1 rounded-md bg-green-600 text-white hover:bg-green-700 transition duration-200">
                                1
                            </button>
                            <button
                                class="px-3 py-1 rounded-md bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-gray-600 transition duration-200">
