            ...
            <div class="overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="p-6 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                        <!-- Students Card -->
                        <div class="bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl shadow-lg p-6 text-white transform transition duration-500 hover:scale-105 animate-on-scroll">
                        ...
                        <!-- Teachers Card -->
                        <div class="bg-gradient-to-r from-green-500 to-green-600 rounded-xl shadow-lg p-6 text-white transform transition duration-500 hover:scale-105 animate-on-scroll">
                            <div class="flex items-center">
                        ...
                        <!-- Courses Card -->
                        <div class="bg-gradient-to-r from-purple-500 to-purple-600 rounded-xl shadow-lg p-6 text-white transform transition duration-500 hover:scale-105 animate-on-scroll">
                            <div class="flex items-center">
                        ...
                        <!-- Attendance Card -->
                        <div class="bg-gradient-to-r from-yellow-500 to-yellow-600 rounded-xl shadow-lg p-6 text-white transform transition duration-500 hover:scale-105 animate-on-scroll">
                            <div class="flex items-center">
                    ...
                    <div class="bg-white dark:bg-gray-700 rounded-xl shadow p-6 animate-on-scroll">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-start p-4 bg-gray-50 dark:bg-gray-600 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-500 transition duration-200">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600 dark:text-gray-300">Ahmad Khan joined Mathematics course</p>
                            ...
                            <div class="flex items-start p-4 bg-gray-50 dark:bg-gray-600 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-500 transition duration-200">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600 dark:text-gray-300">Dr. Sarah Johnson joined as Physics teacher</p>
                            ...
                            <div class="flex items-start p-4 bg-gray-50 dark:bg-gray-600 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-500 transition duration-200">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600 dark:text-gray-300">Advanced Computer Science has been added</p>
