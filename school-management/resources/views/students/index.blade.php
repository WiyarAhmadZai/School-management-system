                ...
                <div class="p-6 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-4">
                                                <div class="text-sm font-medium text-gray-900 dark:text-white">Ahmad
                                                    Khan</div>
                                                <div class="text-sm text-gray-500 dark:text-gray-300">ahmad@example.com
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-4">
                                                <div class="text-sm font-medium text-gray-900 dark:text-white">Fatima
                                                    Ahmed</div>
                                                <div class="text-sm text-gray-500 dark:text-gray-300">fatima@example.com
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-4">
                                                <div class="text-sm font-medium text-gray-900 dark:text-white">Usman
                                                    Malik</div>
                                                <div class="text-sm text-gray-500 dark:text-gray-300">usman@example.com
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                    ...
                    <div class="mt-6 flex items-center justify-between">
                        ...
                        <div class="flex space-x-2">
                            ...
                            <button
                                class="px-3 py-1 rounded-md bg-blue-600 text-white hover:bg-blue-700 transition duration-200">
                                1
                            </button>
                            <button
                                class="px-3 py-1 rounded-md bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-gray-600 transition duration-200">
