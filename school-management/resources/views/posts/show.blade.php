...
@section('content')
                    ...
                    <div class="flex justify-between items-center border-t border-gray-200 dark:border-gray-700 pt-4">
                        ...
                        <div class="flex space-x-4">
                            ...
                            <button type="button"
                                ...
                                <i class="fas fa-share mr-1"></i> <span class="share-count">{{ $post->shares }}</span>
                            </button>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
                ...
                likeButton.addEventListener('click', function(e) {
                    ...
                    fetch(`/posts/${postId}/like`, {
                        ...
                        .then(data => {
                            ...
                            if (showLikesButton) {
                                const likesCount = showLikesButton.querySelector('.likes-count');
                                if (likesCount) {
            ...
            const showLikesButton = document.querySelector('.show-likes-button');
            if (showLikesButton) {
                showLikesButton.addEventListener('click', function(e) {
                    e.preventDefault();
                    const postId = this.getAttribute('data-post-id');
