    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="beautiful-form">
                <h3 class="form-section-title">Grade Information</h3>
                ...
                <form method="POST" action="{{ route('grades.store') }}">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="marks" id="marks" step="0.01" min="0" max="100"
                                class="form-input" value="{{ old('marks') }}">
                            @error('marks')
                                <div class="form-error">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-actions">
                        <a href="{{ route('grades.index') }}" class="btn-secondary">
